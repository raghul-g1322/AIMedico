...
# load model===========================================
svc = pickle.load(open('models/aimedic.pkl','rb'))
...
def home():
    if request.method == 'POST':
        ...
        if symptoms =="Symptoms":
            ...
            dis_des, precautions, rec_medication, rec_diet, workout = helper(predicted_disease)
